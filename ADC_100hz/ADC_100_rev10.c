		...
		while(1){
	    	while((ADS1256_Scan() == 0)) ;
				...
				if (int_on = 1){
					...
					Target_sample.adc_count++ ;
					//printf("----- \n ") ;
					switch (Target_sample.adc_count){
						case 0:
							ch0[size] = g_tADS1256.AdcNow[Target_sample.adc_count] ;
							break ;
						case 1:
							ch1[size] = g_tADS1256.AdcNow[Target_sample.adc_count] ;
							break ;
						case 2:
							ch2[size] = g_tADS1256.AdcNow[Target_sample.adc_count] ;
							size++ ;
							break ;
						case 3:
							break ;
