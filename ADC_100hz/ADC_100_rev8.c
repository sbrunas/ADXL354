...
void ADS1256_ISR(void){
	...
	ch0[Data_ready_count] = g_tADS1256.AdcNow[0] * 100/167 ;
	ch1[Data_ready_count] = g_tADS1256.AdcNow[1] * 100/167 ;
	ch2[Data_ready_count] = g_tADS1256.AdcNow[2] * 100/167 ;
}
